class AlarmClock {
    ...
    addClock(addedTime, act){
        ...
        if (this.alarmCollection.includes((element) => element.time === addedTime)){
    ...
    start(){
        ...
        this.intervalId = setInterval(this.alarmCollection.forEach((element) => mayCall.call(this, element)), 1000);
